...
const App: React.FC = () => {
  ...
  const { dataSource, onDelete: handleDeleteGroup, id, editable = false } = useContext(TableDataContext)
    ...
    <div>
      ...
      {!!editable && (
        <Row justify='space-between'>
          <Button className='mt-4' type="primary" danger onClick={handleDelete(id)}><DeleteFilled className='mr-2' />刪除群組</Button>
          <AddRowButton />
        </Row>
      )}
