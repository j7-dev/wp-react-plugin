...
import EditGWPYearlyFormItem from '@/pages/Check/ScopeI/CheckScopeITable/Table/components/EditGWPYearlyFormItem'
import EditGWPMonthlyFormItem from '@/pages/Check/ScopeI/CheckScopeITable/Table/components/EditGWPMonthlyFormItem'
import EditGWPHourlyFormItem from '@/pages/Check/ScopeI/CheckScopeITable/Table/components/EditGWPHourlyFormItem'
...
const EditRowButton: React.FC<{ record: TYearlyDataType }> = ({ record }) => {
  ...
  const handleData = (theRecord: TYearlyDataType) => {
    const values = form.getFieldsValue()
    const parentKey = theRecord.key.slice(0, -3) || ''
  ...
  const handleOk = (theRecord: TYearlyDataType) => {
    setValidating(true)

    setIsModalOpen(false)
    const dataSources = handleData(theRecord)
      ...
      <EditRowButtonContext.Provider value={record}>
        ...
        >
          ...
          >
            ...
            <Form.Item name={['period']} initialValue={record.period}>
