...
import { EditRowButtonContext } from '@/pages/Check/ScopeI/CheckScopeITable/Table/components/EditRowButton'
...
import { FormContext } from '@/pages/Check/ScopeI/CheckScopeITable/Table/components/EditRowButton'
...
const EditGWPHourlyFormItem = () => {
  ...
  const parentRecords = dataSource.filter((item: TYearlyDataType) =>
          ...
          <Input.Group compact className="mb-4">
            <Form.Item
              ...
              initialValue={
                Math.round(
                  (reverseUnitValue({
                    value: parentRecords[rowIndex]?.yearlyAmount,
                    unit: parentRecords[rowIndex]?.unit,
                  }) /
                    parentRecords[rowIndex]?.hourlyAmount) *
                    1000,
                ) / 1000
              }
              rules={[
